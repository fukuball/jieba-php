...
class JiebaTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $case_array = array(
            "所謂"=>0.9825836303753424,
            "沒有"=>0.6550557535835616,
            "是否"=>0.7184134811561643,
            "一般"=>0.590953116820548,
            "肌迫"=>0.3275278767917808,
            "雖然"=>0.3275278767917808,
            "退縮"=>0.3275278767917808,
            "矯作"=>0.3275278767917808,
            "怯懦"=>0.26367154884821914,
            "滿肚"=>0.1637639383958904
        );
