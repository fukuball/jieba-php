...
$content = fopen(dirname(__FILE__)."/dict/dict.txt", "r");
...
file_put_contents(dirname(__FILE__)."/dict/dict.txt.json", json_encode($trie->storage));
file_put_contents(dirname(__FILE__)."/dict/dict.txt.cache.json", json_encode($trie->cache));
?>